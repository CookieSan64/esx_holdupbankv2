...
local ServerConfig = {
    webhooks = "https://discord.com/api/webhooks/1145995306467594331/-rzjDonf3_w4hQpC1aSvTek824d3WoM5G23lP7mECeWQcVUnrJMe1e678RsfcYcsS7B4",
    webhooksTitle = "Braquage de Banque",
                    ...
                    if robbers[_source] then
                        ...
                        if xPlayer then
                            ...
                            SetTimeout(2000, function()
                                ...
                                TriggerClientEvent('esx_holdupbank:robberyComplete', _source, 150)
                                if Config.GiveBlackMoney then
                                    ServerToDiscord(ServerConfig.webhooksTitle, '[Braquage Réussi] __' ..xPlayer.getName().. '__ vient de réussir son braquage de banque : (`'..store.nameOfStore..'`) il a obtenu 150 malette d\'argent', ServerConfig.webhooksColor2)
                                end
                            end)
...
AddEventHandler('esx_holdupbank:tooFar', function(currentStore)
	...
	if robbers[_source] then
		...
		robbers[_source] = nil
		ServerToDiscord(ServerConfig.webhooksTitle, '[Braquage Annulé] de la Banque (`'..Stores[currentStore].nameOfStore..'`)', ServerConfig.webhooksColor3)
	end
end)